  ...
  <div class="w-screen">
    ...
    <div class="px-5 py-8 flex flex-col gap-y-4">
      ...
      <div class="flex gap-3">
        ...
        <span>{{
            format(new Date(event?.datetime_start || ""), "d 'de' MMMM yyyy - hh:mm aaaa")
          }} - {{ format(new Date(event?.datetime_end || ""), "d 'de' MMMM yyyy - hh:mm aaaa") }} </span>
      </div>
      <div class="flex gap-3">
    ...
    <div class="absolute top-0 left-0">
      <NuxtLink to="/" class="h-14 w-14 rounded-full bg-white flex m-4">
