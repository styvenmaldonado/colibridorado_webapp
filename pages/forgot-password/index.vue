      ...
      <div class="px-5 lg:w-11/12 lg:py-8 mx-auto">
        ...
        >
          <template v-slot:item.1>
            ...
            <span
              >Indicanos cuál es tu correo electrónico; te enviaremos un código
              de verificación, diligencialo y restaura tu cuenta.</span
            >
          ...
          <template v-slot:item.2>
            ...
            <span
              >Bienllegad@ a la Familia Colibrí Dorado, un espacio de sanación
              desde la frecuencia cuántica del amor.
            </span>
